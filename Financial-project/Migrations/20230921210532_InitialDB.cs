        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transfers_Accounts_AccountIdFrom",
                        column: x => x.AccountIdFrom,
                        principalTable: "Accounts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transfers_Accounts_AccountIdTo",
                        column: x => x.AccountIdTo,
                        principalTable: "Accounts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transfers_AccountIdFrom",
                table: "Transfers",
                column: "AccountIdFrom");

            migrationBuilder.CreateIndex(
                name: "IX_Transfers_AccountIdTo",
                table: "Transfers",
                column: "AccountIdTo");
        }
